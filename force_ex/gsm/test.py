...
def parse_arguments(verbose=True):
    ...
    parser.add_argument('-CONV_TOL', type=float, default=0.00002,
    ...
    parser.add_argument('-max_gsm_iters', type=int, default=1000,
    ...
    parser.add_argument('-conv_Ediff', default=0.005, type=float, help='Energy difference convergence of optimization.')
    parser.add_argument('-conv_dE', default=1., type=float, help='State difference energy convergence')
    parser.add_argument('-conv_gmax', default=0.0002, type=float, help='Max grad rms threshold')
...
def create_lot(inpfileq: dict, geom):
    ...
    if lot_name.lower() == "ase":
        ...
        if inpfileq['constraints_file'] != None:
            constraints = read_constraints_file(inpfileq['constraints_file'])
        else:
            constraints = [[None]]
